...
The Db2 connector has a Criterion benchmark for the current ODBC implementation. It follows the Sybase benchmark shape so the mixed projection and primitive typed-buffer path can be tracked separately.
