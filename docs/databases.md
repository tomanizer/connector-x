...
ConnectorX supports retrieving data from Postgres, MsSQL, MySQL, Oracle, SQLite, BigQuery, Sybase, and IBM Db2. This chapter introduces how to use ConnectorX to connect each database and the conversion between database types and Pandas types.
